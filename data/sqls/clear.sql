...
/*清空配置历史纪录*/
DROP TABLE tb_config_update_history_2014;
...
DROP TABLE tb_member_log_2014;
DROP TABLE tb_member_log_2014;
DROP TABLE tb_member_log_2014;

DELETE FROM tb_member_msg;
DROP TABLE tb_member_trend_login_2014;
DROP TABLE tb_member_trend_register_2014;
DROP TABLE tb_member_log_2014;
DROP TABLE tb_member_log_remark_2014;
DROP TABLE tb_member_config_update_history_2014;
...
DROP TABLE tb_website_trend_register_2014;
DROP TABLE tb_website_trend_click_in_2014;
DROP TABLE tb_website_trend_click_out_2014;
...
DROP TABLE tb_website_trend_search_2014;

/*清空网站申请*/
DELETE FROM tb_website_apply_register;
DELETE FROM tb_website_apply_register_intro;
DELETE FROM tb_website;
DROP TABLE tb_website_trend_apply_register_2014;

/*清除管理员垃圾数据*/
DELETE FROM tb_manager_log;
DELETE FROM tb_manager_log_remark;
DROP TABLE tb_manager_log_2014;
DROP TABLE tb_manager_log_remark_2014;
